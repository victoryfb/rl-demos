<<<<<<< HEAD:Policy-Gradient/reinforce/run_lunar_lander.py
import gym
...
agent = Agent(lr=0.0005, gamma=0.99, n_actions=4, layer1_size=256,
              layer2_size=256)
...
plt.plot(x, running_avg)
plt.savefig(filename)
>>>>>>> f6d8081a9291eed762277a0c9deb7ab208d08d65:Policy-Gradient/vanilla/run_lunar_lander.py
